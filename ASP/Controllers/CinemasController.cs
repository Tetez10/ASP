...
namespace ASP.Controllers
{
    public class CinemasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Logo,Name,description,MovieId")] Cinema cinema)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Logo,Name,description,MovieId")] Cinema cinema)
        {
            if (id != cinema.id)
            {
                return NotFound();
